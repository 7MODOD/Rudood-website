...
export const faqs: FaqItem[] = [
  {
    q: "بما أن جميع الباقات تشمل محادثات غير محدودة وكل المنصات، ما الفرق بينها؟",
    a: "الفرق يعتمد على مستوى ذكاء البوت والمهام التي ينفذها بدلاً عنك. الباقة (الأساسية) مخصصة للرد على الأسئلة الشائعة من بيانات متجرك. بينما الباقة (المتقدمة) هي بمثابة موظف مبيعات متكامل؛ قادرة على تسجيل الطلبات والبيانات مباشرة في Google Sheets، قراءة الصور، وتحليل الرسائل الصوتية. أما باقة الشركات فهي مصممة للربط البرمجي العميق (API) مع أنظمتك الخاصة.",
  },
  {
