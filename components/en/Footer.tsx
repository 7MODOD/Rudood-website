    ...
    <footer className="bg-surface border-t border-border">
      ...
      <div className="relative overflow-hidden border-b border-border/50">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse 80% 100% at 50% 0%, rgba(37,99,235,0.08) 0%, rgba(124,58,237,0.05) 50%, transparent 100%)",
          }}
        />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="text-text-muted text-lg mb-8 max-w-xl mx-auto">
            Join today and let Rudood handle your customer service — 24/7 on all platforms.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href="#contact"
              className="px-8 py-4 rounded-full bg-brand-gradient text-white font-bold text-lg hover:opacity-90 transition-all duration-200 shadow-brand"
            >
              Get Started
            </a>
            <a
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="space-y-4">
            <Logo size={40} showText={true} lang="en" textClass="text-xl text-text-primary" />
            <p className="text-text-muted text-sm leading-relaxed">
              Rudood empowers store owners and businesses to deliver intelligent customer service via WhatsApp,
              Instagram & Messenger — 24/7, no extra staff needed.
            </p>
