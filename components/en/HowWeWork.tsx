  ...
  return (
    <section id="how" className="py-24 bg-[#F8FAFC]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {steps.map((step, index) => (
              <div key={step.number} className="relative flex flex-col items-center text-center group">
                ...
                <div className="relative z-10 w-[104px] h-[104px] rounded-full bg-[#F1F5F9] border-2 border-slate-200 group-hover:border-[#2563EB]/60 transition-all duration-300 flex flex-col items-center justify-center mb-6 group-hover:shadow-brand-sm">
                  <span className="text-[#0891B2] text-xs font-black tracking-widest mb-1">
                    {step.number}
                  </span>
        ...
        {/* Timeline Banner */}
        <div className="mt-16 rounded-2xl border border-[#2563EB]/20 bg-[#2563EB]/5 p-6 sm:p-8 flex flex-col sm:flex-row items-center gap-4 sm:gap-6 text-center sm:text-left">
          ...
          <div>
            <h3 className="text-xl font-black text-[#1E1B4B] mb-1">
              Full setup in just{" "}
              <span className="text-[#0891B2]">3 - 7</span> business days
            </h3>
