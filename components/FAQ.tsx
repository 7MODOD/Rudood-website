...
const faqs = [
  {
    ...
    a: "النظام مدرّب خصيصاً على بيانات بزنسك ويعمل بنموذج GPT-4o، من أكثر النماذج دقةً في العالم. الأخطاء نادرة جداً، وعندما يواجه سؤالاً خارج نطاق تدريبه، يُبلّغك ولا يختلق إجابة. نحن أيضاً نراقب الأداء باستمرار ونحسّن التدريب.",
  },
  {
