      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-4">
            ...
            <p className="text-[#0891B2] font-bold text-lg">الحل مع ردود</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="relative p-6 rounded-2xl border border-slate-200 bg-white hover:border-blue-300 transition-all duration-300 group cursor-default shadow-sm hover:shadow-md"
            >
              {/* Highlight badge */}
              <div className="absolute top-4 end-4 text-xs font-bold text-[#2563EB] bg-blue-50 px-2 py-0.5 rounded-full border border-blue-200">
                {feature.highlight}
              </div>

              <div className="w-12 h-12 rounded-xl bg-blue-50 border border-blue-200 flex items-center justify-center text-[#2563EB] mb-4 group-hover:bg-blue-100 group-hover:scale-110 transition-all">
                {feature.icon}
              </div>
